...
//        testUpdate("PART", "WASTAGE", "PARTID",1006, randDub(7, 15));
    ...
    /**
     * Used to generate a random double value between a specific max and min
     * @param min min value of the random
     * @param max max value of the random
     * @return Returns resultant random double.
     */
    ...
    /**
     * Used to print int array results generated by the DBIO insert/update methods.
